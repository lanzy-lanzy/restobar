...
def generate_sales_report_pdf(data):
    ...
    elements.append(Paragraph(f"Generated by: {data['cashier_name']}", styles['CustomNormalCenter']))
...
def generate_simple_sales_report_pdf(data):
    ...
    elements.append(Paragraph(f"Generated by: {data['cashier_name']}", styles['SimpleNormalCenter']))
