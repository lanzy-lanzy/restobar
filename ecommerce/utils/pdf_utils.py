...
def generate_sales_report_pdf(
    ...
    # Add title
    elements.append(Paragraph("5th Avenue Grill and Restobar", styles['Title']))
    elements.append(Paragraph("Sales Report", styles['Subtitle']))
    elements.append(Paragraph(f"From {date_from.strftime('%B %d, %Y')} to {date_to.strftime('%B %d, %Y')}", styles['Normal-Center']))
    elements.append(Paragraph(f"Generated by: {cashier_name}", styles['Normal-Center']))
    elements.append(Spacer(1, 0.3*inch))
    
    # Add summary section
    elements.append(Paragraph("Sales Summary", styles['SectionTitle']))
    ...
    elements.append(Paragraph("Sales by Payment Method", styles['SectionTitle']))
    ...
    elements.append(Paragraph("Sales by Category", styles['SectionTitle']))
    ...
    elements.append(Paragraph("Top Selling Items", styles['SectionTitle']))
    ...
    elements.append(Paragraph("Sales by Order Type", styles['SectionTitle']))
    ...
    # Add footer
    elements.append(Paragraph(f"© {date_from.strftime('%Y')} 5th Avenue Grill and Restobar. All rights reserved.", styles['Normal-Center']))
